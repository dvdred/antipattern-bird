...
def draw_lives(surf, lives):
    surf.blit((pygame.font.SysFont("dejavusansmono", 28) or pygame.font.SysFont("Segoe UI Emoji Regular", 28) or pygame.font.SysFont(None, 28)).render("❤ "*lives, True, (255,0,0)),
              (10, 10))
