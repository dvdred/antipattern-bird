...
* 🎮 Having fun while coding (it's a game project after all!)
...
### AntiPattern Bird Community Values

This is a fun, educational game project about programming antipatterns. We value:

- 🎮 **Fun**: Enjoy the process of contributing
- 📚 **Learning**: Help others learn and grow
- 🔧 **Quality**: Write good code (avoid the antipatterns we're making fun of!)
- 🌈 **Creativity**: Bring new ideas to the table
- 🤝 **Collaboration**: Work together to make the game better
...
**Remember**: We're here to have fun building a game together. Be excellent to each other! 🚀
